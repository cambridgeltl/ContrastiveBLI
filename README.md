...
sh run_all.sh
```
Since our method is symmetric, it is not needed to run source->target translation and target->source translation separately. Each of Stage C1 and Stage C2 will output 4 scores in a single run, for each language pair. I.e., for a language pair (L1, L2), you will get the following 4 scores together: 
