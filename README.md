...
sh run_all.sh
```
Both Stage C1 and Stage C2 will output 4 scores in a single run, for each language pair. 
E.g., for a language pair (L1, L2), you will get the following 4 scores together: 
